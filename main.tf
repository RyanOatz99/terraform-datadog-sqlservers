...
resource "datadog_monitor" "sql_servers_dtu_forecast" {
  ...
  tags = concat(
    [
      ...
      "type:${var.monitor_type != "" ? var.monitor_type : var.type_sql_servers_dtu_forecast}",
...
resource "datadog_monitor" "sql_servers_dtu_status" {
  ...
  tags = concat(
    [
      ...
      "customer_id:${var.customer_id}",
      "team_in_charge:${var.team_in_charge}",
      "type:${var.monitor_type != "" ? var.monitor_type : var.type_sql_servers_dtu_status}",
...
resource "datadog_monitor" "sql_servers_dwu_forecast" {
  ...
  tags = concat(
    [
      ...
      "customer_id:${var.customer_id}",
      "team_in_charge:${var.team_in_charge}",
      "type:${var.monitor_type != "" ? var.monitor_type : var.type_sql_servers_dwu_forecast}",
...
resource "datadog_monitor" "sql_servers_dwu_usage" {
  ...
  tags = concat(
    [
      ...
      "customer_id:${var.customer_id}",
      "team_in_charge:${var.team_in_charge}",
      "type:${var.monitor_type != "" ? var.monitor_type : var.type_sql_servers_dwu_usage}",
